...
\title{Efficient graph-based image segmentation of aerial images for road detection\titlenote{This report was written in the spring of 2013 in the advanced level course MAA507 "Mathematics behind internet" at M\"{a}lardalen University, Sweden.}}
...
\input{method.tex}
\input{digitalImageProcessing.tex}
\input{egbis.tex}
